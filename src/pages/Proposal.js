      ...
      <div className="text-black max-w-xl p-5 mx-auto bg-white">
        <div className="text-center">
          ...
          <div className="my-3 text-2xl">
            <p>You introduced yourself to me when you went to my graduation celebration UNINVITED and it is only fitting that I be to end it. so Babu I am Breaking up with you! I am breaking up with you because i don't want to be your boyfriend anymore.</p><br/>
